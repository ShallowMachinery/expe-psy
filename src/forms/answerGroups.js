const answerGroups = {
  ...
  "Surprise": {
    ...
    related: ["Nabigla", "Pagkamangha", "Nagimbal", "Shocked", "Stunned", "Astonished", "Startled", "Amazed"],
  ...
  "Anger": {
    ...
    related: ["Suklam", "Naiinis", "Nabubuwisit", "Nabubwisit", "Naiirita", "Annoyed", "Irritated", "Rage", "Hatred", "Pissed", "Buwisit", "Bwisit", "Mad", "Dismay", "Frustrated"],
  ...
  "Sadness": {
    ...
    related: ["Pighati", "Nagluluksa", "Hinagpis", "Nalulumbay", "Naiiyak", "Unhappy", "Forlorn", "Heartbroken", "Gloomy", "Depressed", "Blue"],
