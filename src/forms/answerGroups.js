const answerGroups = {
  ...
  "Surprise": {
    exact: ["Surprised", "Pagkagulat", "Gulat", "Nagugulat", "Nagulat"],
    related: ["Nabigla", "Pagkamangha", "Nagimbal", "Shocked", "Stunned", "Astonished", "Startled"],
  ...
  "Sadness": {
    ...
    related: ["Pighati", "Nagluluksa", "Hinagpis", "Nalulumbay", "Naiiyak", "Unhappy", "Forlorn", "Heartbroken", "Gloomy", "Depressed"],
